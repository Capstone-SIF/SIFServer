...
class sockServer:
	...
	def recieveData(self, client_sock, client_addr):
		...
		processed_imageName = tuple( imageName.split('_'))
		print processed_imageName
		cameraID, timeTaken, lat, lon, powerData = processed_imageName
		powerData = tuple(powerData.split('.'))
